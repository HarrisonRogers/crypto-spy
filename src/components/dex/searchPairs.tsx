    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-2">
        ...
        <Input
          id="search-input"
          type="text"
          placeholder="Search pairs... (e.g., ETH, USDC, 0x...)"
          value={inputValue}
      ...
      {!debouncedSearchValue && !isLoading && (
        <div className="text-center py-8 text-gray-400">
          Enter a search term to find trading pairs
        </div>
      )}
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Liquidity {usdTag}</TableHead>
                <TableHead>Market Cap {usdTag}</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {data.pairs.map((pair) => (
